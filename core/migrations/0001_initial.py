    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(blank=True, max_length=255, null=True, verbose_name='Ubicación/Dirección')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_group', models.BooleanField(default=False, help_text='Marcar si es título de grupo', verbose_name='¿Es Grupo?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bonus', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Bonificación')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vat_amount', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='IVA Crédito')),
                ...
                ('payment_method', models.CharField(choices=[('CASH', 'Efectivo / Caja Chica'), ('CARD', 'Tarjeta de Crédito / Débito'), ('TRANSFER', 'Transferencia Bancaria'), ('CHECK', 'Cheque'), ('CREDIT', 'Crédito (Cuenta por Pagar)')], default='CASH', max_length=20, verbose_name='Método de Pago')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.CharField(blank=True, max_length=255, verbose_name='Concepto de Línea')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, max_length=50, null=True, verbose_name='Código/SKU')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('CASH', 'Efectivo'), ('TRANSFER', 'Transferencia Bancaria'), ('CARD', 'Tarjeta de Crédito/Débito'), ('CHECK', 'Cheque'), ('CREDIT', 'Crédito (Por Pagar)')], default='CASH', max_length=20, verbose_name='Método de Pago')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.branch', verbose_name='Sucursal de Facturación')),
